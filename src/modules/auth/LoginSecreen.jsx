  ...
  export const LoginScreen = ({ onForgotPasswordClick }) => {
    ...
    const formik = useFormik({
      initialValues: {
        email: "", // Cambiado de email a username para que coincida con el formulario
        password: "",
      },
      validationSchema: yup.object().shape({
        ...
        onSubmit: async (values) => {
          try {
            let response = await AxiosClient.post("http://localhost:8080/api-sysstock/auth/login", values);
            ...
            if (response.statusCode === 200) {
              ...
              throw new Error(`Error en la solicitud. Código de estado: ${response.statusCode}`);
            }
          } catch (error) {
    ...
    const handleForgotPasswordClick = (e) => {
      e.preventDefault();
      onForgotPasswordClick(); // Llama a la función proporcionada para cambiar al formulario de recuperación de contraseña
    };
              ...
              <Row className="d-flex justify-content-center align-items-center h-100">
                <Col className="col-xl-9">
                  <Card className="rounded-3 text-black" id="pruebita2">
                    <Row className="g-0">
                    <Col className="col-lg-6 d-flex align-items-center justify-content-center gradient-custom-2" id="left">
                      ...
                      <Col className="clo-lg-6 d-flex align-items-center justify-content-center gradient-custom-2">
                        <Card.Body className="p-md mx-md-20">
                          ...
                          <Form onSubmit={formik.handleSubmit}>
                            ...
                            <div className="text-center">
                              <a
 href="#" onClick={handleForgotPasswordClick}                                target="_blank"
